    ...
    <div class="unauthorized-card">
      ...
      <div class="unauthorized-header">
        <div class="error-icon">
          <c-icon name="warning-2" size="4rem" color="red.500" />
        </div>
      ...
      <div class="unauthorized-content">
        ...
        <div v-if="showContext" class="context-info">
          <!-- Role Requirements -->
          <c-alert 
            v-if="requiredRoles && requiredRoles.length > 0" 
            status="info" 
            variant="subtle"
          >
            <c-alert-icon />
            <c-alert-title>Required Roles</c-alert-title>
            <c-alert-description>
          ...
          <!-- Current Roles -->
          <c-alert 
            v-if="currentRoles && currentRoles.length > 0" 
            status="warning" 
            variant="subtle"
          >
            <c-alert-icon />
            <c-alert-title>Your Current Roles</c-alert-title>
            <c-alert-description>
          ...
          >
            <c-alert-icon />
            <c-alert-title>Store Access Required</c-alert-title>
            <c-alert-description>
              Access to store <c-code>{{ storeId }}</c-code> is required for this page.
            </c-alert-description>
          </c-alert>

          <!-- Available Stores -->
          <div v-if="availableStores && availableStores.length > 0" class="store-selection">
            <c-text font-weight="semibold" mb="2">Available Stores:</c-text>
        ...
        <div class="unauthorized-actions">
          ...
          <div class="secondary-actions">
            ...
            >
              <c-icon name="building-store" mr="2" />
              Select Store
            </c-button>
...
const showContext = computed(() => {
  return requiredRoles.value.length > 0 || 
