  ...
  >
    ...
    <div class="app-sidebar__container">
      ...
      <div class="app-sidebar__header">
        <!-- Store selector -->
        <div v-if="showStoreSelector" class="app-sidebar__store-selector">
          <StoreSelector
      ...
      <nav class="app-sidebar__navigation">
        <div class="app-sidebar__sections">
          <!-- Global navigation -->
          <div
            v-if="navigation.global.length > 0"
          ...
          <div
            v-if="selectedStoreId && navigation.store.length > 0"
            class="app-sidebar__section"
          >
            <div
      ...
      <div class="app-sidebar__footer">
        <div v-if="!collapsed" class="app-sidebar__footer-content">
          <div class="app-sidebar__version">
            GO Commerce v{{ appVersion }}
          </div>
          <div class="app-sidebar__support">
            <NavLink
              href="mailto:support@gocommerce.com"
              class="app-sidebar__support-link"
            >
