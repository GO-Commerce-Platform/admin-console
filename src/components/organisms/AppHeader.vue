      ...
      <div v-if="!isMobile" class="app-header__center">
        <div class="app-header__search">
          <div class="app-header__search-input-wrapper">
            ...
            />
            <div class="app-header__search-icon">
              🔍
            </div>
          </div>
          ...
          <Transition name="search-dropdown">
            ...
            >
              <div v-if="searchResults.length > 0" class="app-header__search-results-list">
                <div
                ...
                >
                  <div class="app-header__search-result-content">
                    <div class="app-header__search-result-title" v-html="result.highlightedLabel"></div>
                    <div class="app-header__search-result-section">{{ result.section.title }}</div>
                  </div>
                </div>
              </div>
              <div v-else-if="searchQuery" class="app-header__search-no-results">
      ...
      <div class="app-header__right">
        ...
        <div class="app-header__user-menu">
          ...
          >
            ...
            <div v-if="!isMobile" class="app-header__user-info">
          ...
          <Transition name="user-menu">
            <div v-if="userMenuOpen" class="app-header__user-dropdown">
