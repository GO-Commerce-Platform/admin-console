...
<template>
  ...
  >
    ...
    <CFlex justify="space-between" align="flex-start"
mb="4">
      <CBox>
        <!-- Icon -->
        <CBox
        ...
        >
          <CIcon :name="icon" color="white"
boxSize="5" />
        </CBox>

        <!-- Title -->
        <CText fontSize="sm" color="text.secondary"
fontWeight="500">
          {{ title }}
        </CText>
      </CBox>
...
boxSize="4" mr="1" />
    ...
    <!-- Main metric value -->
    <CText fontSize="3xl"
fontWeight="700" color="text.primary" lineHeight="1.2" mb="1">
      <AnimatedNumber
    ...
    <CText v-if="subtitle" fontSize="xs"
color="text.tertiary">
      {{ subtitle }}
    </CText>

    <!-- Progress bar (optional) - Using custom div since CProgress is not available -->
...
<script setup lang="ts">
  ...
  import { CBox, CFlex, CText, CIcon } from '@chakra-ui/vue-next'
